...
public class DetailKuisionerSudahIsiAdapter extends RecyclerView.Adapter<DetailKuisionerSudahIsiAdapter.ItemRowHolder> {
    ArrayList<KuisionerModel> dataKuisioner;
    private Activity activity;

    public DetailKuisionerSudahIsiAdapter(Activity activity, ArrayList<KuisionerModel> dataKuisioner){
        this.dataKuisioner = dataKuisioner;
        this.activity = activity;
    }

    @Override
    public DetailKuisionerSudahIsiAdapter.ItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_detail_kuisioner_sudah_isicardview, viewGroup, false);
        DetailKuisionerSudahIsiAdapter.ItemRowHolder mh = new DetailKuisionerSudahIsiAdapter.ItemRowHolder(view);
        return mh;
    }

    @Override
    public void onBindViewHolder(DetailKuisionerSudahIsiAdapter.ItemRowHolder holder, int i) {
