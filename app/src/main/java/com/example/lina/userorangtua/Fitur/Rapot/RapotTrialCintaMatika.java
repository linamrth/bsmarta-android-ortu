...
public class RapotTrialCintaMatika extends AppCompatActivity {
    private RapotTrialModel rapotTrialModel;
    private TextView tvNama, tvKelas, tvProgram, tvNamaguru;
    private TextView tvSoal1, tvSoal2, tvSoal3, tvSoal4, tvSoal5, tvSoal6, tvSoal7, tvSoal8, tvCatatan;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rapot_trial_cintamatika);
